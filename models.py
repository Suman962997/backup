            ...
            "questions": [
              {
                ...
                "questionOptions": [],
                "questionAnswer":force.Details_of_business(file_path,"Details of business activities (accounting for 90% of the turnover)")
              ...
              },
              {
                ...
                "questionAnswer":force.Products_Services(file_path,"Details of business activities (accounting for 90% of the turnover)")
...
def parse_brsr_text_section_c(json_merge):
  return {
    "data":[
      {
            ...
            "questions": [
              {
                ...
                {
                    "option": "a",
                    "questionAnswer": json_merge["Monetary"]
                  },
                  {
                    "option": "b",
                    "questionAnswer": json_merge["Non-Monetary"]
                  }
                ],
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Of the instances disclosed in Question 2 above, details of the Appeal/ Revision preferred in cases where monetary or non-monetary action has been appealed."],
              },
                {
                "questionNo": "4",
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Number of Directors/KMPs/employees/workers against whom disciplinary action was taken by any law enforcement agency for the charges of bribery/ corruption"],
              },
                {
                "questionNo": "6",
                "question": "Details of complaints with regard to conflict of interest",
                "questionOptions": [],
                "questionAnswer": json_merge["Details of complaints with regard to conflict of interest"],
              },
                {
                "questionNo": "7",
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Number of days of accounts payables ((Accounts payable *365) / Cost of goods/services procured) in the following format:"],
              },
                {
                "questionNo": "9",
                ...
                {
                    "option": "a",
                    "questionAnswer": json_merge["Provide details of concentration of purchases and sales with trading houses, dealers, and related parties along-with loans and advances & investments, with related parties, in the following format:"]
                  },
                ],
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Awareness programmes conducted for value chain partners on any of the Principles during the financial year:"],
              },
                {
                "questionNo": "11",
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Does the entity have processes in place to avoid/ manage conflict of interests involving members of the Board? (Yes/No) If Yes, provide details of the same."],
              }
            ...
            "questions": [
              {
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Percentage of R&D and capital expenditure (capex) investments in specific technologies to improve the environmental and social impacts of product and processes to total R&D and capex investments made by the entity, respectively."],
              },
              {
                "questionNo": "2",
            ...
            "questions": [
              {
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Describe the mechanisms in place to receive and respond to consumer complaints and feedback."],
              },
              {
                "questionNo": "2",
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Turnover of products and/ services as a percentage of turnover from all products/service that carry information about:"]
              },
              {
                "questionNo": "3",
                "question": "Number of consumer complaints in respect of the following:",
                "questionOptions": [],
                "questionAnswer": json_merge["Number of consumer complaints in respect of the following:"],
              },

              {
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Details of instances of product recalls on account of safety issues:"],
              },

              {
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Does the entity have a framework/policy on cyber security and risks related to data privacy? (Yes/No). If available, provide weblink of the policy."],
              },
...

              {
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Provide the following information relating to data breaches:"],
              },
...

              {
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Channels / platforms where information on products and services of the entity can be accessed (provide web link, if available)."],
              },

              {
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Steps taken to inform and educate consumers about safe and responsible usage of products and/or services."],
              },

              {
                ...
                "questionOptions": [],
                "questionAnswer": json_merge["Mechanisms in place to inform consumers of any risk of disruption/discontinuation of essential services."],
              },
              ...
              },
              {
                ...
                "questionOptions":[
                                         {
                    "option": "a",
                    "questionAnswer": json_merge["Number of instances of data breaches along-with impact"]
                  },
                  {
                    "option": "b",
                    "questionAnswer": json_merge["Percentage of data breaches involving personally identifiable information of customers"]
                  }],
                "questionAnswer": json_merge["Provide the following information relating to data breaches:"]
              }
...
async def extract_document(file: UploadFile = File(...),questionKey: str = Form(...)):
    ...
    if questionKey=="section_a":
      ...
      try:
          ...
          merged = merge_results(results)
          print(merged)
          res=parse_brsr_text_section_c(merged)
          return res          
...
if __name__ == "__main__":
    uvicorn.run("models:app", host="0.0.0.0", port=10000, reload=False, log_level="debug" )
