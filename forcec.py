            ...
            if text and question in text or question_2 in text  or question_3 in text:
                ...
                for i in finallist:
                    ...
                    if len(parts)>=8:
                        ...
                        output_10=parts
                #("51",output_9,len(output_9))
                #("54",output_10,len(output_10))                
                if len(output_9)<3 and len(output_10)<3:                    
                    return str(finallist)
                elif output_9:
                    #("output-9 is exist",output_9,len(output_9))
                    getlast=output_9[-9:]
                    #(getlast)
                    princ=[]
                    for i in getlast:
                    ...
                    #("output-10 is exist",output_10,len(output_10))
                    princ=[]
                    for i in output_10:
                        if len(i)<=3:
                            princ.append(i)
...
#(Percentage_coverage_training("C:/Users/coda/Documents/deigeo.pdf","Percentage coverage by training and awareness programmes on any of the"))
#("************")
...
#(Monetary("C:/Users/coda/Documents/deigeo.pdf","Details of fines/penalties/punishment/award"))
#("************")
...
#(Penalty_Fines("C:/Users/coda/Documents/deigeo.pdf","Penalty/Fines"))
#("************")
...
#(Settlement("C:/Users/coda/Documents/deigeo.pdf","Penalty/Fines"))
#("************")
...
#(Compounding_Fee("C:/Users/coda/Documents/deigeo.pdf","Details of fines/penalties/punishment/award"))
#("************")
...
#(Non_Monetary("C:/Users/coda/Documents/deigeo.pdf","Details of fines/penalties/punishment/award"))
#("************")
...
#(Of_the_instances_disclosed("C:/Users/coda/Documents/deigeo.pdf","Of the instances disclosed in Question 2 above, details of the Appeal/ Revision "))
#("************")
...
#(anti_corruption_or_anti_bribery_policy("C:/Users/coda/Documents/deigeo.pdf","Does the entity have an anti-corruption or anti-bribery policy? If yes, provide "))
#("************")
...
#(Directors_KMPs_employees_workers("C:/Users/coda/Documents/deigeo.pdf","Number of Directors/KMPs/employees/workers against whom disciplinary action was taken by any law enforcement"))
#("************")
...
#(Details_of_complaints_with("C:/Users/coda/Documents/deigeo.pdf","Details of complaints with regard to conflict of interest"))
#("************")
...
#(taken_or_underway_on_issues("C:/Users/coda/Documents/deigeo.pdf","Provide details of any corrective action taken or underway on issues related to fines / penalties / action taken by regulators/"))
#("************")
...
#(Number_of_days_of_accounts_payables("C:/Users/coda/Documents/deigeo.pdf"," Number of days of accounts payables ((Accounts payable *365) / Cost of goods/services"))
#("************")
...
#(concentration_of_purchases("C:/Users/coda/Documents/deigeo.pdf","Provide details of concentration of purchases"))
#("************")
...
#(Awareness_programmes_conducted("C:/Users/coda/Documents/deigeo.pdf","Awareness programmes conducted for value chain partners on any of the Principles"))
#("************")
...
#(place_to_avoid_manage_conflict("C:/Users/coda/Documents/deigeo.pdf"," Does the entity have processes in place to avoid/ manage conflict of interests involving members of the Board"))
#("************")
...
#(Percentage_of_R_and_D("C:/Users/coda/Documents/deigeo.pdf","Percentage of R&D and capital expenditure (capex) investments in specific technologies to improve the environmental and social"))
#("************")
...
#(place_for_sustainable_sourcing("C:/Users/coda/Documents/deigeo.pdf","Does the entity have procedures in place for sustainable sourcing? (Yes/No)"))
#("************")
...
#(procedures_in_place("C:/Users/coda/Documents/deigeo.pdf","Does the entity have procedures in place for sustainable sourcing? (Yes/No)"))
#("************")
...
#(place_to_safely_reclaim_your_products("C:/Users/coda/Documents/deigeo.pdf","Describe the processes in place to safely reclaim your products for reusing"))
#("************")
...
#(Whether_Extended_Producer_Responsibility_EPR("C:/Users/coda/Documents/deigeo.pdf","Whether Extended Producer Responsibility (EPR) is applicable to the entity’s activities (Yes / No). If yes, whether the waste collection plan is in line with the "))
#("************")
...
#(Life_Cycle_Perspective("C:/Users/coda/Documents/deigeo.pdf","Has the entity conducted Life Cycle Perspective / Assessments (LCA) for any of its products (for manufacturing industry) or for its services"))
#("************")
...
#(significant_social_or_environmental("C:/Users/coda/Documents/deigeo.pdf","If there are any significant social or environmental concerns and/or risks arising fro+D28m production or disposal of your products / services, as"))
#("************")
...
#(Percentage_of_recycled("C:/Users/coda/Documents/deigeo.pdf","Percentage of recycled or reused input material to total material (by value) used in production (for manufacturing industry) or providing services (for service industry)"))
#("************")
...
#(Of_the_products_and_packaging("C:/Users/coda/Documents/deigeo.pdf","Of the products and packaging reclaimed at end of life of products, amount (in metric tons) reused, recycled, and safely disposed"))
#("************")
...
#(Reclaimed_products("C:/Users/coda/Documents/deigeo.pdf","Reclaimed products and their packaging materials (as percentage of products sold)"))
#("************")
...
#(well_being_of_employees("C:/Users/coda/Documents/deigeo.pdf","Details of measures for the well-being of employees"))
#("************")
...
#(well_being_of_Workers("C:/Users/coda/Documents/deigeo.pdf","Details of measures for the well-being of Workers"))
#("************")
...
#(towards_well_being_of_employees("C:/Users/coda/Documents/deigeo.pdf","Spending on measures towards well-being of employees and workers (including permanent and other than permanent) in the"))
#("************")
...
#(Details_of_retirement_benefits("C:/Users/coda/Documents/deigeo.pdf","Details of retirement benefits, for Current Financial Year and Previous Financial Year"))
#("************")
...
#(Accessibility("C:/Users/coda/Documents/deigeo.pdf","Accessibility of workplaces"))
#("************")
...
#(Return_to_work("C:/Users/coda/Documents/deigeo.pdf","Return to work and Retention rates of permanent employees and workers that took parental leave"))
#("************")
...
#(Is_there_mechanism("C:/Users/coda/Documents/deigeo.pdf","Is there a mechanism available to receive and redress grievances for the following categories of employees and worker"))
#("************")
...
#(Membership_of_employees("C:/Users/coda/Documents/deigeo.pdf"," Membership of employees and worker in association(s) or Unions recognised by the listed entity"))
#("************")
...
#(Details_of_training("C:/Users/coda/Documents/deigeo.pdf","Details of training given to employees and workers"))
#("************")
...
#(Details_of_performance("C:/Users/coda/Documents/deigeo.pdf","Details of performance and career development reviews of employees and workers:"))
#("************")
...
#(Health_safety_management("C:/Users/coda/Documents/deigeo.pdf","Health and safety management system:"))
#("************")
...
#(processes_used_to_identify("C:/Users/coda/Documents/deigeo.pdf","What are the processes used to identify work-related hazards and assess risks on a routine and non-routine basis by the entity"))
#("************")
...
#(workers_report_work("C:/Users/coda/Documents/deigeo.pdf","Whether you have processes for workers to report the work related hazards and to remove themselves from such risks"))
#("************")
...
#(non_occupational_medical_and_healthcare("C:/Users/coda/Documents/deigeo.pdf","Do the employees/ worker of the entity have access to non-occupational"))
#("************")
...
#(Details_safety_related("C:/Users/coda/Documents/deigeo.pdf","Details of safety related incidents, in the following format"))
#("************")
...
#(safe_and_healthy_work_place("C:/Users/coda/Documents/deigeo.pdf","Describe the measures taken by the entity to ensure a safe and healthy work place"))
#("************")
...
#(Number_of_Complaints("C:/Users/coda/Documents/deigeo.pdf","Number of Complaints on the following made by employees and workers"))
#("************")
...
#(Assessments_for_the_year("C:/Users/coda/Documents/deigeo.pdf","Assessments for the year:"))
#("************")
...
#(safety_practices_and_working_conditions("C:/Users/coda/Documents/deigeo.pdf","Provide details of any corrective action taken or underway to address safety-related incidents (if any) and on significant risks / concerns arising from assessments of health & safety practices and working conditions."))
#("************")
...
#( compensatory_package("C:/Users/coda/Documents/deigeo.pdf","Does the entity extend any life insurance or any compensatory package in the event of death of (A) Employees"))
#("************")
...
#(Provide_measures_undertaken("C:/Users/coda/Documents/deigeo.pdf","Provide the number of employees / workers having suffered high consequence work- related injury / ill-health"))
#("************")
...
#(transition_assistance_programs("C:/Users/coda/Documents/deigeo.pdf","Does the entity provide transition assistance programs to facilitate continued employability and the management of career endings resulting from retirement or termination of employment"))
#("************")
...
#(Details_on_assessment("C:/Users/coda/Documents/deigeo.pdf","Details on assessment of value chain partners"))
#("************")
...
#(conditions_value_chain_partners("C:/Users/coda/Documents/deigeo.pdf","Provide details of any corrective actions taken or underway to address significant risks / concerns"))
#("************")
